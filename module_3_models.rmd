...
save(model_m1, model_m1_eq, model_mrq1a, model_mrq1b, model_mtot, file = "./data/model_real_out.RData")
...
save(data_m1, data_m1_eq, data_mrq1a, data_mrq1b, data_mtot, file = "./data/modeldata_real_out.RData")
```
...
save(model_mequality_new, model_m1, model_m1_eq, model_mrq1a, model_mrq1b, file = "./data/model_real_out.RData")
save(data_mequality_new, data_m1, data_m1_eq, data_mrq1a, data_mrq1b, file = "./data/modeldata_real_out.RData")
```