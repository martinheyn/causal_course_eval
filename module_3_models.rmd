...
model_mreturn <- ulam(log_lik=TRUE,
      ...
      logit(p) <- a[Swedish] + c[StudyPeriod] + b_p * Prereq_s + b_l * LearningOut_s + b_s * Structure_s + b_t * Teaching_s + b_li * Literature_s + b_a * Assessment_s + b_ad * Admin_s + b_w * Workload_s + b_e * Equality_s,
      a[Swedish] ~ dnorm(0, 1),
